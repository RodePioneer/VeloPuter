...
const byte switchSpdPin =       0; // NOTE: 0 and 1 are the RX and TX pins. 
const byte switchCadPin =       1; // NOTE: 0 and 1 are the RX and TX pins. 
